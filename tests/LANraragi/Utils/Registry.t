...
note('testing resolve_cdn_artifact_url does not encode dot-segments...');

{
    my $result = LANraragi::Utils::Registry::resolve_cdn_artifact_url(
        "https://cdn.example.com/r", "../etc/passwd"
    );
    is( $result, "https://cdn.example.com/r/../etc/passwd", "dot-segments pass through unchanged" );
}
